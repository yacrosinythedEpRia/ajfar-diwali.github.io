...
;( function( window ) {
	...
	Photostack.prototype._initEvents = function() {
		...
		document.getElementById("yasin").addEventListener("click", function(){
				self._rotateItem();
		});
		document.getElementById("yasin1").addEventListener("click", function(){
			self._rotateItem();
	});
	document.getElementById("yasin2").addEventListener("click", function(){
		self._rotateItem();
});
document.getElementById("yasin3").addEventListener("click", function(){
	self._rotateItem();
});
document.getElementById("yasin4").addEventListener("click", function(){
	self._rotateItem();
});
document.getElementById("yasin5").addEventListener("click", function(){
	self._rotateItem();
});
document.getElementById("yasin6").addEventListener("click", function(){
	self._rotateItem();
});
		document.getElementById("yasin7").addEventListener("click", function(){
	self._rotateItem();
});
